...
var DashboardPage = /** @class */ (function () {
    // constructor
    function DashboardPage(assetService, trainBooking, router, route, vcf, dialog) {
    ...
    DashboardPage.prototype.viewBooking = function (trainBooking) {
        console.log(JSON.stringify(trainBooking));
        this.router.navigate(['/detail', trainBooking.bookingNo]);
    };
