...
var trainBooking_Service_1 = require("../services/trainBooking-Service");
var test_page_1 = require("./dashboard/test.page");
var train_Booking_detail_page_1 = require("./dashboard/train.Booking.detail.page");
    ...
    AppModule = __decorate([
        core_1.NgModule({
            declarations: [
                ...
                train_Booking_detail_page_1.TrainBookingDetailPage,
            ],
            imports: [
            ...
            providers: [trainBooking_Service_1.TrainBookingService, asset_service_1.AssetService],
